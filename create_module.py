...
folders = [
    f"{base_path}/{module_name}",
    f"{base_path}/{module_name}/models",
    f"{base_path}/{module_name}/views",
    f"{base_path}/{module_name}/security",
    f"{base_path}/{module_name}/static",
]
...
manifest_content = f"""{{
    ...
    'description': 'Descripcion de {module_name}',
    'author': 'Breiner',
    'depends': ['base'],
    'data': [
...
with open(f"{base_path}/{module_name}/__manifest__.py", "w") as f:
    f.write(manifest_content)


with open(f"{base_path}/{module_name}/__init__.py", "w") as f:
    f.write("from . import models")


with open(f"{base_path}/{module_name}/models/__init__.py", "w") as f:
...
"""
with open(f"{base_path}/{module_name}/models/{module_name}.py", "w") as f:
...
"""
with open(f"{base_path}/{module_name}/views/{module_name}_views.xml", "w") as f:
...
with open(f"{base_path}/{module_name}/security/ir.model.access.csv", "w") as f:
